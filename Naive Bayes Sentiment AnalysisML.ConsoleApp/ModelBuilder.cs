...
using Naive_Bayes_Sentiment_AnalysisML.Model;

namespace Naive_Bayes_Sentiment_AnalysisML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\mhabi\Desktop\train.txt";
        private static string MODEL_FILEPATH = @"../../../../Naive_Bayes_Sentiment_AnalysisML.Model/MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.MulticlassClassification.Trainers.NaiveBayes(labelColumnName: "Sentiment", featureColumnName: "Features")
                .Append(mlContext.Transforms.Conversion.MapKeyToValue("PredictedLabel", "PredictedLabel"));
